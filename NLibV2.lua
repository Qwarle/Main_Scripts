...
if CoreGui:FindFirstChild("LunixxxLibrary") then
...
shamanScreenGui.Name = "LunixxxLibrary"
...
function sectiontable:MakeLabel(Info)
...
function sectiontable:MakeButton(Info)
...
function sectiontable:MakeToggle(Info)
...
function sectiontable:MakeSlider(Info)
...
function sectiontable:MakeDropdown(Info)
